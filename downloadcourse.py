...
# Copyright 2013 Sudheesh Singanamalla <sudheesh1995@outlook.com>. All Rights Reserved.
#
#---------------------------------------------                             
...
# Add courses by yourself. Not all tested. You can give feedback.
# Download videos, subtitles, PDF and PPT(X) slides.
# Has problem to resolve subtitles for 'modelthinking'.
...
def initialize_browser(course, email, password):
    ...
    br.submit()
    print 'It takes a few seconds to login and resolve resources to download...\n'
...
def main():
    print '----------------------------------'
    print '-        Coursera Downloader     -'
    print '-      by Sudheesh Singanamalla  -'
    print '----------------------------------'
    print
    # Add courses by yourself. Not all tested. You can feed back.
    # The string here are extensions eg. 'algo' from https://www.coursera.org/course/algo , everything
    # after the word /course/<whatever is here> put it in a string. Place it between the ''.
    course = { '1' : 'algo',
               '2' : 'saas',  
               '3' : 'modelthinking',
               '4' : '',
    ...
    email = 'youremail' #Change it here in the code. I'll later optimize it for direct input. eg. gmail@yahoo.com :P
    password = 'password' #Your password in plain text. eg. sillypassword123
# Sorry I know this makes it a little insecure, Don't share your code with others with these credentials in the code
# I'll try improving on it to allow input in console. If anyone else of you wish to do it, please go ahead and then send me the 
# update.
    if email == 'youremail':
        print 'You must change the email and the password to yours in main() first.'
        sys.exit(1)
# Shows where the path is downloaded to. Don't mess with the download_path function
# Uses process.argv command line control. Messing this up could end up formatting your downloads folder.
    path  = download_path()
